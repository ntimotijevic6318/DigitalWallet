...
public class IncomFragment extends Fragment {
    ...
    public static final String EditKey = "EditItem";

    public  IncomFragment(){
        super(R.layout.icom_fragment_layout);
    }
    ...
    private void initRecycler() {
        ...
        startActivity(intent);
            ...
            sharedViewModel.removeIncome(itemToDelete);
            return  null;
        } , itemToEdit-> {
            Intent intent = new Intent(getContext() , EditActivity.class);
            intent.putExtra(EditKey,  itemToEdit);
        ...
        switch (requestCode){
            case 111:
                if(resultCode == Activity.RESULT_OK){
                    ...
                    sharedViewModel.editItemIncome(item);
                }
        }
    }
    ...
    private void initView(View view) {
        recyclerView = view.findViewById(R.id.RecyclerViewIncom);
    }
